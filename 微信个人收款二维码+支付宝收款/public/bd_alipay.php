<?php
	...
	$payAmount = $_GET['payAmount'];
		$memo = "订单产品：".$_GET['bdproduct']."，姓名（会员名）：".$_GET['bdname']."，手机号(QQ号)：".$_GET['bdmob']."，订单编号：".$_GET['out_trade_no'];
	$smsNo = $_GET['bdmob'];
?>
<html>
<head>
...
<title>扫一扫二维码，支付宝APP免手续费付款</title>
<style type="text/css">
...
<img src="skm.jpg" width="30%">
</div>
<div align="center" style="font-family: '微软雅黑'; font-size: 18px; color: #071BF5; width:100%; " >请用手机打开支付宝APP，扫一扫上面的二维码图案，<br>免手续费向本站付款<span style="color: #F50707"><?php echo $payAmount ?></span>元。<br>付款前请确保收款支付宝账号是<span style="color: #F50707"><?php echo $optEmail ?></span>，建议付款说明中填写亲提交订单时填写的手机号(QQ号)码“<span style="color: #F50707"><?php echo $smsNo ?></span>”，方便核对订单信息，谢谢！<br>
